...
// here we access RSS-feed and show corresponding headlines
    ...
    TextView title;
    ListView myListView; String urlAddress = "", urlCaption = "", channel = ""; SingleItem selectedNewsItem;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState); setContentView(R.layout.activity_main);
        myListView = (ListView)this.findViewById(R.id.myListView);
        title = (TextView)this.findViewById(R.id.channels);
...
// update app’s top ‘TitleBar’ (eg. ‘NPR - Business Wed April 09, 2014’)
        this.setTitle(urlCaption);
            title.setText("ITEMS IN CHANNEL " + urlCaption + " - " + channel );
        myListView = (ListView)this.findViewById(R.id.myListView);
